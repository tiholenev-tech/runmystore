...
body { background: #030712; color: #e2e8f0; font-family: 'Montserrat', sans-serif; height: 100dvh; display: flex; flex-direction: column; overflow: hidden; padding-bottom: var(--nav-h); }
...
.hdr { position: relative; z-index: 50; background: rgba(3,7,18,.92); backdrop-filter: blur(24px); border-bottom: 1px solid rgba(99,102,241,.12); padding: 12px 16px 0; flex-shrink: 0; }
.hdr-top { display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px; gap: 10px; }
.brand { font-size: 18px; font-weight: 800; flex: 1; background: linear-gradient(to right, #f1f5f9, #a5b4fc, #f1f5f9); background-size: 200% auto; -webkit-background-clip: text; -webkit-text-fill-color: transparent; animation: gShift 6s linear infinite; }
.store-pill { font-size: 11px; font-weight: 700; color: rgba(165,180,252,.7); background: rgba(99,102,241,.08); border: 1px solid rgba(99,102,241,.15); border-radius: 20px; padding: 4px 10px; max-width: 110px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.hdr-icon { width: 34px; height: 34px; border-radius: 10px; background: rgba(99,102,241,.1); border: 1px solid rgba(99,102,241,.2); display: flex; align-items: center; justify-content: center; cursor: pointer; color: #a5b4fc; position: relative; flex-shrink: 0; }
...
.tabs { display: flex; }
.tab { flex: 1; padding: 8px 4px; font-size: 13px; font-weight: 700; color: #4b5563; text-align: center; border-bottom: 2px solid transparent; cursor: pointer; text-decoration: none; transition: all .2s; display: block; }
...
.pro-label { font-size: 10px; font-weight: 700; color: #6366f1; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; }
...
.pro-action { display: inline-flex; align-items: center; gap: 4px; padding: 4px 10px; border-radius: 8px; font-size: 11px; font-weight: 700; background: rgba(99,102,241,.12); border: 1px solid rgba(99,102,241,.25); color: #a5b4fc; cursor: pointer; font-family: inherit; }
.pro-close { position: absolute; top: 7px; right: 8px; width: 20px; height: 20px; border-radius: 50%; background: rgba(255,255,255,.04); border: none; color: #4b5563; font-size: 11px; cursor: pointer; display: flex; align-items: center; justify-content: center; }
...
.typing-wrap { display: none; padding: 10px 13px; background: rgba(12,12,30,.88); border: 1px solid rgba(99,102,241,.14); border-radius: 4px 16px 16px 16px; width: fit-content; margin-bottom: 12px; backdrop-filter: blur(8px); }
...
.quick-btn  { flex-shrink: 0; padding: 7px 13px; border-radius: 20px; font-size: 12px; font-weight: 700; border: 1px solid rgba(99,102,241,.18); color: #6b7280; background: rgba(12,12,30,.7); backdrop-filter: blur(8px); cursor: pointer; font-family: inherit; transition: all .2s; white-space: nowrap; display: flex; align-items: center; gap: 5px; }
...
.voice-wrap.recording .voice-inner { background: linear-gradient(135deg, #ef4444, #dc2626); box-shadow: 0 0 28px rgba(239,68,68,.7), 0 0 56px rgba(239,68,68,.25); }
...
.rec-stop  { padding: 11px 30px; background: rgba(239,68,68,.12); border: 1px solid rgba(239,68,68,.3); border-radius: 24px; color: #ef4444; font-size: 14px; font-weight: 700; cursor: pointer; font-family: inherit; }
