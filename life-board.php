...
<main class="app">
  ...
  <div class="glass sm wfc q4" data-range="7">
    ...
    <!-- 1 динамична препоръка на база реалните weather данни -->
...
<!-- ═══ AI HELP CARD (новa секция, qhelp) ═══ -->
  <div class="glass sm help-card qhelp">
    ...
    <div class="help-chips">
      <button class="help-chip" onclick="openChatQ('Какво ми тежи на склада')"><span class="help-chip-q">?</span><span>Какво ми тежи на склада</span></button>
      <button class="help-chip" onclick="openChatQ('Кои са топ продавачите')"><span class="help-chip-q">?</span><span>Кои са топ продавачите</span></button>
      <button class="help-chip" onclick="openChatQ('Какво да поръчам')"><span class="help-chip-q">?</span><span>Какво да поръчам</span></button>
      <button class="help-chip" onclick="openChatQ('Защо приходите паднаха')"><span class="help-chip-q">?</span><span>Защо приходите паднаха</span></button>
      <button class="help-chip" onclick="openChatQ('Покажи ми артикул')"><span class="help-chip-q">?</span><span>Покажи ми артикул</span></button>
      <button class="help-chip" onclick="openChatQ('Какво продаваме днес')"><span class="help-chip-q">?</span><span>Какво продаваме днес</span></button>
    </div>
...
<!-- layout. JS секцията долу свързва rmsOpenChat()/lbV2OpenQ().           -->
<!-- ═══════════════════════════════════════════════════════════════════ -->
<style>
