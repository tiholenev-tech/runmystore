<?php
/**
 * partials/header.php — Unified RunMyStore header (S82.SHELL)
 * Brand + plan badge + theme toggle + spacer + printer + settings + logout.
...
<header class="rms-header" id="rmsHeader">
    ...
    <a href="settings.php" class="rms-icon-btn" title="Настройки" aria-label="Настройки">
