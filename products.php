...
''; // S73.B.13: footer via helper
        ...
        return '<div class="wiz-page active" style="padding-bottom:80px">'+
            ...
            '<div id="v4Footer" style="position:fixed;left:0;right:0;bottom:0;padding:8px 12px calc(8px + env(safe-area-inset-bottom,24px)) 12px;background:rgba(10,11,20,0.98);backdrop-filter:blur(14px);border-top:1px solid hsl(var(--hue1) 30% 20% / 0.5);z-index:201;display:flex;gap:6px;max-width:480px;margin:0 auto">'+_footer+'</div>'+
            vskip+'</div>';
    }
