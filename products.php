...
function renderWizPage(step){
    ...
    if(step===3){
        ...
        const photoBlock=S.wizData._photoDataUrl
            ? '<img src="'+S.wizData._photoDataUrl+'" onclick="document.getElementById(\'filePickerInput\').click()" style="width:100%;height:160px;object-fit:cover;border-radius:14px;margin-bottom:14px;cursor:pointer">'
            : '<div onclick="document.getElementById(\'filePickerInput\').click()" style="aspect-ratio:16/9;border-radius:14px;background:rgba(255,255,255,0.025);border:1.5px dashed rgba(255,255,255,0.12);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;margin-bottom:14px;cursor:pointer"><div style="width:42px;height:42px;border-radius:12px;background:linear-gradient(135deg,rgba(99,102,241,0.25),rgba(59,130,246,0.2));border:1px solid rgba(99,102,241,0.35);display:flex;align-items:center;justify-content:center;margin-bottom:4px"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#a5b4fc" stroke-width="1.6"><rect x="3" y="3" width="18" height="18" rx="3"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg></div><div style="font-size:12px;font-weight:500">Снимай артикула</div><div style="font-size:9px;color:var(--text-secondary)">AI ползва снимката за описание</div></div>';
        ...
        return '<div class="wiz-page active" style="padding-bottom:70px">'+
            ...
            '<div class="fg">'+fieldLabel('Цена дребно *','price')+'<div style="display:flex;gap:6px;align-items:center"><input type="number" step="0.01" inputmode="decimal" class="fc" id="wPrice" oninput="S.wizData.retail_price=parseFloat(this.value)||0" value="'+pr+'" placeholder="0.00" style="flex:1">'+mic('retail_price')+'</div></div>'+
            qtyBlock+
