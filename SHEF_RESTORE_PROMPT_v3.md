...
## ⛔ АБСОЛЮТНИ ПРАВИЛА v3.1 (09.05.2026 сутрин)

### Правило #A — РАБОТНА ДИРЕКТОРИЯ (CRITICAL)
Преди ВСЯКА команда към Claude Code, шеф чатът започва промпта с:
PHASE 0 verify cwd: pwd && cd /var/www/runmystore && pwd && git rev-parse HEAD
Ако CC отговори с pwd != /var/www/runmystore -> СПИРА и пита Тихол. Алтернативни clone-ове (/home/tihol/runmystore и др.) са ЗАБРАНЕНИ.

### Правило #B — КРАТКОСТ
Шеф чатът отговаря с максимум 2-3 изречения, освен ако Тихол изрично каже "разширено" или изпълнява EOD протокол. Никакви bullet списъци за status освен явно поискани.

### Правило #C — STATUS REPORT БЕЗ FILE LIST
При boot шеф чатът НЕ изрежда прочетените файлове. Започва директно с:
IQ TEST X/16 (Tier1 a/10, Tier2 b/5, Tier3 c/1)
[1-2 изречения red flags]
[Top 3 priority]
ЧАКАМ КОМАНДА.
