...
<div class="page-wrap">
    ...
    <div class="wh-grid">
        <a href="products.php" class="wh-card <?= $low_stock_count > 0 ? 'glow-red' : '' ?>" style="--delay:0.05s">
        ...
        <a href="transfers.php" class="wh-card <?= $pending_transfers > 0 ? 'glow-yellow' : '' ?>" style="--delay:0.1s">
        ...
        <?php if (!$is_seller): ?>
        <a href="deliveries.php" class="wh-card <?= $pending_deliveries > 0 ? 'glow-yellow' : '' ?>" style="--delay:0.15s">
        ...
        <a href="inventory.php" class="wh-card <?= $active_inventory > 0 ? 'glow-yellow' : '' ?>" style="--delay:0.25s">
